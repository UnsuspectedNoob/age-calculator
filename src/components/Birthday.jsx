  ...
  return (
    <div className='flex flex-col mt-3'>
      <button
        ...
        className={`border border-primary-purple px-3 py-2 rounded hover:text-primary-purple w-1/2 self-center bg-primary-purple text-neutral-off-white hover:bg-neutral-off-white transition text-sm focus:ring-1 focus:ring-primary-purple`}
      >
